...
const reglas = [
  ...
  ["proyectos/metodologia-agua-de-por-medio.html", /va por la v([\d.]+) \(/, "version"],
  ["proyectos/metodologia-agua-de-por-medio.html", /va por la v[\d.]+ \((\d+) obras/, "entradas"],
  ["proyectos/metodologia-agua-de-por-medio.html", /va por la v[\d.]+ \(\d+ obras y (\d+) relaciones/, "relaciones"],
  ...
  ["proyectos/metodologia-agua-de-por-medio-en.html", /is at v([\d.]+) \(/, "version"],
  ["proyectos/metodologia-agua-de-por-medio-en.html", /is at v[\d.]+ \((\d+) works/, "entradas"],
  ["proyectos/metodologia-agua-de-por-medio-en.html", /is at v[\d.]+ \(\d+ works and (\d+) relations/, "relaciones"],
