...
(function () {
  function init() {
    ...
    var nodos = [
      { nombre: 'Kingston',          pais: 'Jamaica',            lat: 17.9712, lng: -76.7936, categoria: 'Gran Caribe',        desc: 'De aquí salieron los cimarrones de Trelawny deportados en 1796, aquí nació Marcus Garvey y aquí el rastafari volvió la mirada hacia Etiopía. Puerto matriz del panafricanismo popular.', claves: ['Cimarrones', 'Marcus Garvey', 'Rastafari'], cultura: 'Gumbé · Mento · Reggae · Dancehall', cancion: { titulo: 'Redemption Song', artista: 'Bob Marley', youtubeId: 'yv5xonFSC4c' } },
      ...
      { nombre: 'Puerto España',     pais: 'Trinidad y Tobago',  lat: 10.6549, lng: -61.5019, categoria: 'Gran Caribe',        desc: 'Cuna del calipso y de tres arquitectos del panafricanismo: Henry Sylvester Williams, organizador del primer congreso panafricano (1900), George Padmore y C.L.R. James.', claves: ['Sylvester Williams', 'Padmore · C.L.R. James', 'Calipso'], cultura: 'Calipso · Soca · Steelpan', cancion: { titulo: 'Birth of Ghana', artista: 'Lord Kitchener', youtubeId: '057BmLQ9MfU' } },
      ...
      { nombre: 'Barranquilla',      pais: 'Colombia',           lat: 10.9685, lng: -74.7813, categoria: 'Caribe colombiano',  desc: 'Puerto de verbenas y picós. Desde 2014, Radio Cultural FM retransmite aquí Rumba Africana: la orilla colombiana del puente sonoro que este mapa dibuja.', claves: ['Picós', 'Verbenas', 'Radio Cultural FM'], cultura: 'Cumbia · Salsa · Música africana de picó' },
      { nombre: 'Cartagena de Indias', pais: 'Colombia',         lat: 10.3910, lng: -75.4794, categoria: 'Caribe colombiano',  desc: 'Antiguo puerto negrero convertido en capital de la champeta criolla: los picós hicieron del soukous, el highlife y la palmwine music una música propia del Caribe negro colombiano.', claves: ['Champeta criolla', 'San Basilio de Palenque', 'Picós'], cultura: 'Champeta · Bullerengue · Terapia', cancion: { titulo: 'El Mecánico', artista: 'Charles King' } },
    ...
    var rutas = [
      ...
      { epoca: 1, de: 'Nueva York', a: 'Johannesburgo', curva: 0.12, titulo: 'Espirituales: el primer estéreo panafricano', anos: '1890–1898', desc: 'Los Virginia Jubilee Singers de Orpheus McAdoo llegaron a Ciudad del Cabo en julio de 1890 y fueron un fenómeno: los coros de la élite negra sudafricana adoptaron los espirituales y fundaron los African Jubilee Singers. Tsitsi Jaji lee ahí el comienzo del «estereomodernismo»: la música afroamericana escuchada en África como forma ya codificada de resistencia creativa.', claves: ['Orpheus McAdoo', 'African Jubilee Singers', 'Estereomodernismo (Jaji)'], cancion: { titulo: 'Swing Low, Sweet Chariot (1909)', artista: 'Fisk Jubilee Singers', youtubeId: 'GUvBGZnL9rE' }, fuente: 'Jaji 2014 · Erlmann 1991' },
      ...
      { epoca: 2, de: 'Puerto España', a: 'Freetown', curva: 0.14, titulo: 'Regimientos y calipso', anos: '1914–1945', desc: 'Los soldados caribeños de los British West Indian Regiments llevaron el calipso a África occidental. En Freetown se cruzó con el gumbé y la palmwine y nació la maringa que Ebenezer Calender volvió clásica. «Everybody Loves Saturday Night» es de ida y de vuelta: nadie sabe ya de qué orilla es.', claves: ['West Indian Regiments', 'Calipso y maringa', 'Canciones sin orilla'], cancion: { titulo: 'Everybody Loves Saturday Night', artista: 'tradicional atlántica' }, fuente: 'Montes Pizarro 2018' },
      ...
      { epoca: 3, de: 'Kingston', a: 'Adís Abeba', curva: 0.28, titulo: 'Etiopía: el retorno sagrado', anos: '1930–hoy', desc: 'La coronación de Haile Selassie (1930) confirmó para el etiopianismo jamaiquino una profecía: un rey negro en África. El rastafari hizo de Etiopía horizonte espiritual, de Shashamane tierra de repatriación y del reggae su vehículo planetario.', claves: ['Etiopianismo', 'Repatriación', 'Reggae roots'], cancion: { titulo: 'Exodus', artista: 'Bob Marley & The Wailers', youtubeId: 'OSOqWgqwynQ' }, fuente: 'Adi 2018 · Manuel 1995' },
      ...
      { epoca: 4, de: 'Brazzaville', a: 'Fort-de-France', curva: 0.24, titulo: 'Ry-Co Jazz: África toca en las Antillas', anos: '1967–1971', desc: 'Fundada por Henri Bowane, curtida en giras por África occidental y radicada luego en París, la Ry-Co Jazz llegó en 1967 a Martinica y Guadalupe. Su rumba congoleña se mezcló con la biguine y el konpa: una de las semillas de lo que germinaría como zouk.', claves: ['Rythme Congolais', 'Gira antillana 1967', 'Semilla del zouk'], cancion: { titulo: 'Bonne Année', artista: 'Ry-Co Jazz', youtubeId: 'Gto9mh58vRE' }, fuente: 'Montes Pizarro 2018' },
      { epoca: 4, de: 'Kinshasa', a: 'Cartagena de Indias', curva: 0.2, titulo: 'Champeta: el soukous desembarca', anos: '1970–hoy', desc: 'Marinos y coleccionistas trajeron a Cartagena y Barranquilla discos de soukous, highlife y mbaqanga. Los picós los volvieron patrimonio popular y los músicos locales los criollizaron: la champeta criolla es África escuchada, bailada y reinventada desde el Caribe colombiano.', claves: ['Picós', 'Terapia criolla', 'África reinventada'], cancion: { titulo: 'Shakalaodé', artista: 'Wganda Kenya', youtubeId: 'bMOajYNU60E' }, fuente: 'Montes Pizarro 2018 · Pacini Hernandez 1993' },
