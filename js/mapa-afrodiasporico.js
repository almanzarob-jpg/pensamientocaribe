...
(function () {
  function init() {
    ...
    var nodos = [
      ...
      { nombre: 'Barranquilla',      pais: 'Colombia',           lat: 10.9685, lng: -74.7813, categoria: 'Caribe colombiano',  desc: 'En las verbenas de San Roque y los barrios populares, picós con nombre propio —El Coreano, El Timbalero, El Gran Fidel, El Isleño— volvieron la «música africana» cultura de barrio, con comerciantes y corresponsales que viajaban por discos exclusivos (Giraldo 2016). Desde 2014, Radio Cultural FM retransmite aquí Rumba Africana, y ASOBAILES impulsa el picó como patrimonio.', claves: ['Verbenas de San Roque', 'El Coreano · El Timbalero', 'Picó como patrimonio'], cultura: 'Cumbia · Salsa · Música africana de picó', cancion: { titulo: 'Shakalaodé', artista: 'Wganda Kenya', youtubeId: 'bMOajYNU60E' } },
      { nombre: 'Cartagena de Indias', pais: 'Colombia',         lat: 10.3910, lng: -75.4794, categoria: 'Caribe colombiano',  desc: 'Antiguo puerto negrero convertido en capital de la champeta: aquí los picós volvieron patrimonio popular los discos africanos y aquí canta la escuela palenquera. Desde 2018, las asociaciones picoteras de Cartagena, Barranquilla y Santa Marta impulsan el picó como patrimonio cultural inmaterial.', claves: ['Champeta', 'Picós · ASOPICAR', 'World Picó 2024'], cultura: 'Champeta · Bullerengue · Terapia', cancion: { titulo: 'El Mecánico', artista: 'Charles King' } },
