...
> Corpus bibliográfico y relacional de un atlas archipiélico del Gran Caribe, construido a partir de fenómenos transversales antes que de fronteras nacionales: colonialidad, postplantación, capitalismo racial, catástrofes climáticas, soberanías, violencias, memoria y espiritualidad, cimarronaje, creolización, y cuerpo, género y erótica.
>
> Esta versión 1.15.0 contiene 233 entradas —228 obras de investigación y 5 manifestaciones culturales— enlazadas por 588 relaciones y ancladas en 30 lugares. Cada relación se tipifica como resonancia o disonancia, siguiendo la distinción que Michael Monahan desarrolla en *Creolizing Practices of Freedom*, y declara su propia fuente: 382 relaciones están corroboradas contra el texto de las obras y las 206 restantes se marcan explícitamente como pendientes en lugar de presentarse como verificadas.
>
> El corpus registra 568 resonancias frente a 20 disonancias. Esa proporción no describe el campo sino el sesgo de quien traza el mapa, que reconoce continuidades con más facilidad que choques, y se publica precisamente para que pueda corregirse.
>
> La versión 1.15.0 añade treinta entradas y ciento cincuenta y nueve relaciones respecto de la 1.14.0, e incorpora dos nodos nuevos: Costa Rica y Granada. Entre las incorporaciones están *Capitalismo y esclavitud* de Eric Williams, el manuscrito inédito *Black Metamorphosis* de Sylvia Wynter, *The Plural Society in the British West Indies* de M. G. Smith y *My Mother Who Fathered Me* de Edith Clarke, junto con la línea de estudios de parentesco caribeño que el corpus no tenía y el bloque de trabajo importado e indentura.
>
> Deudas declaradas de esta versión, verificadas con el validador que se deposita junto al corpus: dos identificadores distintos, `steward` y `stewardpuertorico`, corresponden al mismo libro de 1956 y esperan fusión editorial; cuatro entradas carecen de año; tres no tienen autoría identificada; seis reúnen dos obras bajo un solo identificador y esperan decisión sobre su división; y el lugar `guajira` está definido en el catálogo sin que ninguna entrada lo refiera. El corpus publica estas deudas en lugar de resolverlas en silencio.
>
> Se depositan también los dos validadores que comprueban el corpus, para que la afirmación metodológica del proyecto pueda verificarse y no solo leerse.
>
...
c224e007da86a868021893552d30b7dc  validar-piloto-atlas-2.mjs
```
